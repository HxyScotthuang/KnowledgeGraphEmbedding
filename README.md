Add data file in 
```
wget 'https://www.dropbox.com/scl/fo/69p37v7285vx6whxf6hrt/h?dl=1&rlkey=94vpdnvmwx0bco5e1pjwrdtzi'
mkdir data
unzip 'h?dl=1&rlkey=94vpdnvmwx0bco5e1pjwrdtzi' -d data
rm 'h?dl=1&rlkey=94vpdnvmwx0bco5e1pjwrdtzi'
```
